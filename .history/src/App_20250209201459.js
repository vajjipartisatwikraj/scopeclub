...
function App() {
  ...
  return (
    <div>
      ...
      <div className="wdwd">
        <div className="wdwd-head"></div>
        <div className="wdwe-01-container">
          <div className="wdwd-01-num"></div>
          <div className="wdwd-01">
            <div className="wdwd-01-head"></div>
            <div className="wdwd-01-content"></div>
          </div>
        </div>
        <div className="wdwe-02-container">
          <div className="wdwd-02">
            <div className="wdwd-02-head"></div>
            <div className="wdwd-02-content"></div>
          </div>
          <div className="wdwd-02-num"></div>
        </div>
        <div className="wdwe-03-container">
          <div className="wdwd-03-num"></div>
          <div className="wdwd-03">
            <div className="wdwd-03-head"></div>
            <div className="wdwd-03-content"></div>
          </div>
        </div>
      </div>
