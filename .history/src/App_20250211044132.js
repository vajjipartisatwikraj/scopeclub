    ...
    <div>
      ...
      <div className="footer">
        <div className="footer-container">
          <div className="footer-top-container"><div className="scope"></div>
          <div className="mlrit"></div></div>
          <div className="footer-bottom-container">
          <div className="flwus">
            <h4 className="flwus-text">Follow Us.</h4>
          ...
          <div className="writeus">
            <h4 className="writeus-text">Write Us.</h4>
            <p className="writeus-content">scopeclub@mlrinstitutions.ac.in</p>
          </div>
          <div className="meet">
            <h4 className="meet-text">Meet</h4>
            <p className="meet-content">MT 003-SCOPE CLUB,MLRIT,Dundigal Police Station Road,Hyderabad - 500 043,Telangana, India.</p>
          </div>
          </div>
        </div>
      </div>
