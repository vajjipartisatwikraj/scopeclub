        ...
        <div className="resorces-logos">
          <div className="logo-carousel">
            <div className="logo-track track-left">
              {/* First row - left to right - using naturally white logos */}
              <div className="logo-slide"><img src="https://simpleicons.org/icons/react.svg" alt="React" /></div>
              <div className="logo-slide"><img src="https://simpleicons.org/icons/javascript.svg" alt="JavaScript" /></div>
              <div className="logo-slide"><img src="https://simpleicons.org/icons/python.svg" alt="Python" /></div>
              <div className="logo-slide"><img src="https://simpleicons.org/icons/nodedotjs.svg" alt="Node.js" /></div>
              <div className="logo-slide"><img src="https://simpleicons.org/icons/angular.svg" alt="Angular" /></div>
              <div className="logo-slide"><img src="https://simpleicons.org/icons/vuedotjs.svg" alt="Vue" /></div>
              <div className="logo-slide"><img src="https://simpleicons.org/icons/typescript.svg" alt="TypeScript" /></div>
              <div className="logo-slide"><img src="https://simpleicons.org/icons/html5.svg" alt="HTML5" /></div>
            ...
            <div className="logo-track track-right">
              {/* Second row - right to left - using naturally white logos */}
              <div className="logo-slide"><img src="https://simpleicons.org/icons/mongodb.svg" alt="MongoDB" /></div>
              <div className="logo-slide"><img src="https://simpleicons.org/icons/docker.svg" alt="Docker" /></div>
              <div className="logo-slide"><img src="https://simpleicons.org/icons/firebase.svg" alt="Firebase" /></div>
              <div className="logo-slide"><img src="https://simpleicons.org/icons/github.svg" alt="GitHub" /></div>
              <div className="logo-slide"><img src="https://simpleicons.org/icons/figma.svg" alt="Figma" /></div>
              <div className="logo-slide"><img src="https://simpleicons.org/icons/css3.svg" alt="CSS3" /></div>
              <div className="logo-slide"><img src="https://simpleicons.org/icons/tensorflow.svg" alt="TensorFlow" /></div>
              <div className="logo-slide"><img src="https://simpleicons.org/icons/java.svg" alt="Java" /></div>
