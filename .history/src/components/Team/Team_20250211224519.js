    ...
    <>
      <div className="green-container">
        <div className="top-layer">
          ...
          <h1 ref={(el) => (headingsRef.current[0] = el)} className="head">We Are Team <span className="highlighted">Scope</span>.</h1>
      ...
      <div className="head">
        ...
        <h2 ref={(el) => (headingsRef.current[4] = el)} className="team-p">Board of Directors</h2>
        ...
        <h2 ref={(el) => (headingsRef.current[4] = el)} className="team-p">Team 2k27</h2>
        <div className="bod">
          {t27.map((t) => (
            <TeamCard
              key={t.id}
        ...
        <h2 ref={(el) => (headingsRef.current[4] = el)} className="team-p">Team 2k26</h2>
        <div className="bod">
          {t26.map((t) => (
            <TeamCard
              key={t.id}
        ...
        <h2 ref={(el) => (headingsRef.current[4] = el)} className="team-p">Team 2k24</h2>
        <div className="bod">
          {t24.map((t) => (
            <TeamCard
              key={t.id}
        ...
        <h2 ref={(el) => (headingsRef.current[4] = el)} className="team-p">Team 2k23</h2>
        <div className="bod">
          {t23.map((t) => (
            <TeamCard
              key={t.id}
        ...
        <h2 ref={(el) => (headingsRef.current[4] = el)} className="team-p">Team 2k22</h2>
        <div className="bod">
          {t22.map((t) => (
            <TeamCard
              key={t.id}
