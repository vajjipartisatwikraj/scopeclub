...
function App() {
  ...
  return (
    <div>
      ...
      <div className="wdwd">
        <h2 ref={(el) => (headingsRef.current[0] = el)} className="wdwd-head">What do <span className="highlighted">we DO</span>?</h2>
      ...
      <div className="brand-events">
        ...
        <h2 ref={(el) => (headingsRef.current[0] = el)} className="brand-events-head">Our <span className="highlighted">events</span> define our <span className="highlighted">brand</span>.</h2>
